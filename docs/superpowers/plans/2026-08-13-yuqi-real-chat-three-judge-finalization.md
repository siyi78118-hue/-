...
- [ ] **Step 4: Run focused flow and contract tests green**
...
- [ ] **Step 1: Add a failing unsealing test**
...
- [ ] **Step 2: Run the focused flow test red**

Run: `node --test tests/yuqi-real-chat-three-judge-flow.test.mjs`

Expected: FAIL because the finalizer is missing.

- [ ] **Step 3: Implement finalization and plain-language rendering**
...
- [ ] **Step 4: Run focused and existing evaluation gates**
...
- [ ] **Step 1: Import the user's completed review**
