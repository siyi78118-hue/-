...
assert.match(swScript, /const CACHE_NAME = 'rpchat-v33';/);
assert.match(script, /const MEMORY_DB_VERSION = 2;/);
assert.match(swScript, /const MEMORY_DB_VERSION = 2;/);
assert.match(script, /const APP_BUILD_VERSION = '2026-07-09\.19';/);
assert.match(script, /const EXPECTED_CLOUD_TIMER_VERSION = '2026-07-09\.5';/);
...
assert.match(cloudTimerWorker, /const CLOUD_TIMER_WORKER_VERSION = '2026-07-09\.5';/);
...
assert.match(cloudTimerHealthScript, /EXPECTED_VERSION = '2026-07-09\.5'/);
