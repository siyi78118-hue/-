...
assert.match(swScript, /const CACHE_NAME = 'rpchat-v57';/);
assert.match(script, /const MEMORY_DB_VERSION = 2;/);
assert.match(swScript, /const MEMORY_DB_VERSION = 2;/);
assert.match(script, /const APP_BUILD_VERSION = '2026-07-09\.43';/);
...
assert.match(script, /async function enterProactiveDiceMode\(charId\)/);
