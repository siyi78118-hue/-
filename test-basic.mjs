...
assert.match(script, /cancelCloudProactiveQuick\(deletedId,\s*['"][^'"]+['"]\)/);
...
assert.match(cloudTimerWorker, /const CLOUD_TIMER_WORKER_VERSION = '2026-08-15\.8';/);
...
assert.match(cloudTimerHealthScript, /EXPECTED_VERSION = '2026-08-15\.8'/);
